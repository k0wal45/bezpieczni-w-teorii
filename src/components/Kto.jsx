...
import krzysiu from '../assets/img/manicon.webp'
import { faGithub, faLinkedin } from '@fortawesome/free-brands-svg-icons'
import { faGlobe, faSquareEnvelope } from '@fortawesome/free-solid-svg-icons'

const Kto = () => {
  return (
    <section id='kto' className='flex flex-col items-start justify-center p-4 my-24 gap-24'>
      ...
      <div className="flex flex-col lg:flex-row justify-around items-center gap-8 lg:gap-auto mx-auto w-3/4 ">
        ...
        < div className="flex flex-col rounded-xl border-4 border-base-200 max-w-[22rem] bg-base-200">
          ...
          <div className="flex flex-col gap-4 p-4">
            ...
            <ul className="flex gap-4 flex-wrap max-w-full">
              <li className="rounded-full px-4 py-[3px] bg-white text-black font-codec">W sumie chuj wie cos tam robi</li>
