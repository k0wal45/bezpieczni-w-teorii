...
const Hero = () => {
  return (
    <section id="glowna" className="flex flex-col lg:flex-row justify-center gap-4 items-center lg:px-48 min-h-screen max-w-screen pt-32 pb-12 lg:pb-0 bg-photo border-b-2 border-base-200 shadow-2xl">
